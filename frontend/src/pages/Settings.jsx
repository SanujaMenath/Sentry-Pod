  ...
  return (
    <div className="text-2xl font-bold text-gray-800 mb-1">
      ...
      <div className="grid grid-cols-2 gap-5">
        {/* Notifications */}
        <div className="bg-[#161b22] border border-[#1e2530] rounded-xl p-5">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-[#0d1117] border border-[#1e2530] rounded-lg px-3 py-2.5 text-sm text-gray-300 focus:outline-none focus:border-blue-500"
              />
            </div>
            <div>
        ...
        <div className="bg-[#161b22] border border-[#1e2530] rounded-xl p-5">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3 pt-2">
              <button className="py-2.5 rounded-lg text-sm font-medium bg-[#0d1117] border border-[#1e2530] text-gray-300 hover:text-white transition-colors">
                Backup Now
              </button>
              <button className="py-2.5 rounded-lg text-sm font-medium bg-[#0d1117] border border-[#1e2530] text-gray-300 hover:text-white transition-colors">
                Restore
